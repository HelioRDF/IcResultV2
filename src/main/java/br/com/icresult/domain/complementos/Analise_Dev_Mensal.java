...
@Entity
@Table(name = "Analise_Dev_Mensal")
public class Analise_Dev_Mensal implements Serializable {

	private static final long serialVersionUID = 3440210707050332945L;

	public static Comparator<Analise_Dev_Mensal> getComparadorPorDataCaptura() {
		return new Comparator<Analise_Dev_Mensal>() {
			@Override
			public int compare(Analise_Dev_Mensal o1, Analise_Dev_Mensal o2) {
				return -1 * o1.getDataCaptura().compareTo(o2.getDataCaptura());
			}
		};
	}

	public Analise_Dev_Mensal() {

	}

	public Analise_Dev_Mensal(Captura captura) {
	...
	@Column(name = "Analisar_Descomission")
	private Boolean analisarDescomission;
	...
	public Boolean isAnalisarDescomission() {
		return analisarDescomission;
	}

	public void setAnalisarDescomission(boolean analisarDescomission) {
		this.analisarDescomission = analisarDescomission;
	}

	public Boolean getAnalisarDescomission() {
		return analisarDescomission;
	}
