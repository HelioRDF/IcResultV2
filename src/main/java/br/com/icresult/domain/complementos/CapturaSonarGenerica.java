...
/**
 * -Classe POJO CapturaSonarGenerica, e entity do DB via Hibernate.
 * 
 * @author helio.franca
 * @version v2.5.1
 * @since 18-11-2018
...
@MappedSuperclass
public  class CapturaSonarGenerica implements Serializable {


	private static final long serialVersionUID = 2088710418183500904L;
