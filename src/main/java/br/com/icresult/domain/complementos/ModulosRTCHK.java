...
@Entity(name = "Relacao_Modulos_RTC")
public class ModulosRTCHK extends GenericChaveSonar {
	...
	public String toString() {
		return "ModulosRTCHK [selecionado=" + selecionado + ", capturado=" + capturado + ", alterada="
